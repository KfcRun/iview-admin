    ...
    <Layout>
      <Header class="header-con">
        <header-bar :collapsed="collapsed" @on-coll-change="handleCollapsedChange">
          ...
          <language v-if="$config.plugin['i18n'].useI18n && $config.plugin['i18n'].showI18nParse"
                    @on-lang-change="setLocal" style="margin-right: 10px;" :lang="local"/>
          ...
          <fullscreen v-if="$config.plugin['full-screen'].showFullScreen" v-model="isFullscreen"
